...
(*rhoChain  = Dyad[coherentstate[QubitStateFromBlochVector[1., 0], L]];*)
...
(*  rhoChainSweep = Dyad[coherentstate[QubitStateFromBlochVector[0., 0], L]];*)
...
(*(* Bell state \[LongDash] constant reference across all runs *)*)
(*bellState  = {0,1,0,0};*)
(*(*bellState  = RandomChainProductState[2];*)*)
(*rhoABspin  = Outer[Times, bellState, Conjugate[bellState]];*)
(*rhoABref   = rhoABspin;*)
(**)
(*delta = 10;   (* integer keys: \[CapitalDelta] = k/10 exactly *)*)
(**)
(*(* Base output directory \[LongDash] same folder as the notebook *)*)
(*baseDir = NotebookDirectory[];*)
...
(*(* ============================================================ *)*)
(*betaList = { 1., 10.,20.,50.,100.,Infinity};*)


(* ::Input:: *)
(*{h1,h2}={0,0};*)
(*{Jxy,Jz,w,ed,d}={delta/10.,0.5,0,0,L};*)
...
(*  Ha           = XXZwLocalDefectHamiltonian[Jxy, Jz, w, ed, L, L];*)
(*  HT           = Chop[BuildFullHamiltonian[HAlocal, Ha, HBlocal,*)
(*                       couplingA, couplingB, L]];*)
(*  {Eval, Evec} = DiagonalizeH[HT];*)
(*  Clear[HT];*)
...
(* ::Chapter:: *)
(*Anisotropy \[CapitalDelta] cycle and thermal state together*)


(* ::Input:: *)
(*kDeltaList = {0.1,1.,1.,1000.};   (* integer keys: delta = k/10, exact values *)*)
...
(*  If[!DirectoryQ[dirL], CreateDirectory[dirL]];*)
(**)
(*  Do[   (* \[HorizontalLine]\[HorizontalLine] delta loop \[HorizontalLine]\[HorizontalLine] *)*)
(*    delta = N[k/10];*)
(*    Print["L = ", L, "   \[CapitalDelta] = ", NumberForm[delta, {3,1}], "   ..."];*)
(**)
(*    (* Build and diagonalise ONCE per (L, delta) *)*)
(*    Ha           = XXZwLocalDefectHamiltonian[delta, Jz, w, ed, L, L];*)
(*    HT           = Chop[BuildFullHamiltonian[HAlocal, Ha, HBlocal,*)
(*                         couplingA, couplingB, L]];*)
(*    {Eval, Evec} = DiagonalizeH[HT];*)
(*    Clear[HT];*)
(**)
(*    (* beta-independent \[LongDash] compute once per (L, delta), reuse across beta *)*)
(*    Tmat   = BuildTransferTensors[Evec, L];*)
(*    dEflat = BuildEnergyDiffs[Chop[Eval]];*)
(**)
(*    Do[   (* \[HorizontalLine]\[HorizontalLine] beta loop \[HorizontalLine]\[HorizontalLine] *)*)
(*      beta = betaList[[ib]];*)
...
(*    ];   (* end beta loop *)*)
(**)
(*    (* cleared AFTER the full beta loop for this (L, delta) *)*)
(*    Clear[Ha, Tmat, Evec, Eval, dEflat];*)
(**)
(*    , {k, kDeltaList}*)
(*  ];   (* end delta loop *)*)
